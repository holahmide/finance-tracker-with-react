...
const SideBar = ({ sideBar }) => {
  ...
  const activeLink =
    'w-full p-2 bg-main text-white dark:bg-primary dark:hover:bg-primary hover:bg-main rounded-md mb-3 pl-6';
  const link =
    'w-full p-2 dark:bg-black bg-tertiary-1 hover:bg-main dark:hover:bg-primary rounded-md mb-3 pl-6';
