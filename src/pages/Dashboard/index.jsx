        ...
        <>
            ...
            <div
                ...
                className={`${sideBar ? "text-main border-main border-2" : ""
                    } z-50 md:hidden fixed bottom-0 right-0 m-3 p-3 dark:bg-dark bg-gray-300 rounded-full cursor-pointer shadow-lg text-gray-500 dark:text-gray-400  hover:text-main hover:border-main hover:border-2 transition-all`}
            >
