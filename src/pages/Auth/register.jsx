        ...
        <div>
          ...
          <form onSubmit={submitFormHandler}>
            <div className="text-left mb-3">
              <label className="text-left dark:text-white" htmlFor="firstName">
                First Name
              </label>{' '}
              <br />
              <input
                ...
                type="text"
                name="firstName"
                className="bg-gray-200 dark:bg-gray-900 p-2 outline-none focus:border-l-main dark:focus:border-l-primary shadow-lg border-2 border-transparent border-b-main dark:border-b-primary rounded-sm"
              />
            </div>
            <div className="text-left mb-3">
              <label className="text-left dark:text-white" htmlFor="lastName">
                Last Name
              </label>{' '}
              <br />
              <input
            ...
            <div className="text-left mb-3">
              <label className="text-left dark:text-white" htmlFor="confirmPassword">
                Confirm Password
              </label>{' '}
              <br />
              <input
            ...
            <div className="mt-2">
              ...
              <Link to="/login" className="text-secondary dark:text-primary">
                Login
              </Link>
            </div>
          </form>
